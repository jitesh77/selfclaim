...
// Global variables
var proformaId = proformaData.id;
var ssid = proformaData.userSsid;
...
$(document).ready(function() {
	...
	$('#createProforma input[data-field="patientName"]').val(proformaData.patientName);
	$('#createProforma input[data-field="userName"]').val(proformaData.user.name);
	$('#createProforma input[data-field="userMobile"]').val(proformaData.user.mobile);
	$('#createProforma input[data-field="userEmail"]').val(proformaData.user.email);
	$('#createProforma input[data-field="userEmail"]').val(proformaData.user.email);
	$('#createProforma input[data-field="proformaDate"]').val(formatDate(proformaData.proformaDate));
	$('#createProforma input[data-field="writeOffAmount"]').val(proformaData.writeOffAmount);
	$('#createProforma input[data-field="discountAmount"]').val(proformaData.discountAmount);
	$('#createProforma input[data-field="proformaComment"]').val(proformaData.proformaComment);
